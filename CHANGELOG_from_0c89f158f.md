...
| `mobile_dwfpn_pplcnetV4_acn.yml` | PPLCNetV4_det_acn | DWRSEFPN(96) | DBHead | ACNet+MobileOne |
| `mobile_dwfpn_pplcnetV4_acn_tiny.yml` | PPLCNetV4_det_acn_tiny | DWRSEFPN(96) | DBHead | ACNet+MobileOne |
| `mobile_dwfpn_pplcnetV4_v7b_tiny.yml` | PPLCNetV4_det_v7b_tiny | DWRSEFPN(96) | DBHead | V7B block |
| `mobile_dwfpn_pplcnetV4_v7b_tiny_v2.yml` | PPLCNetV4_det_v7b_tiny_v2 | DWRSEFPN(96) | DBHead | V7B v2 |
